	...
	<div class="row gy-5 g-xl-8">
				...
				<div class="card-body box-profile">
					<div class="text-center mb-3">
						<!--<img class="profile-user-img img-fluid img-circle" src="--><?php //echo base_url('/assets/adminLTE3/foto-profil/' . $data_foto) 
																						?>
						<!--">-->
						<img class="img-fluid rounded w-75" src="<?php echo ($data_foto != 'no_image.jpg') ? base_url('/assets/media/profiles/') . $data_foto : base_url('/assets/media/avatars/blank.png'); ?>">
					</div>
		...
		<div class="col-md-8">
			...
			<div class="card card-primary">
				...
				<div class="card-body pt-0" enctype="multipart/form-data">
					<div class="mb-3 row">
