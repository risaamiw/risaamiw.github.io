...
<body>
    ...
    <section class="section">
        <div class="row" style="margin-top: 50px; width:100%;">
            <div class="col-md-12 col-xs-6 col-12 col-lg-12 ps-3">
                <h1 style="font-family:poppins;"><b>Anggota Tim</b></h1>
                <a href="<?php echo base_url('content/hubungi') ?>" class="btn btn-info btn-sm" style=" margin-left:86%; margin-top:-50px; height:34px; font-family:poppins; border-radius:8px;">Hubungi</a>
                <div class="table">
                    <table class="" width="100%" cellspacing=" 0" cellpadding="0">
                        <?php foreach ($kontak as $list) { ?>
                            <tr style="font-family: poppins;">
                                <th scope="col" class="py-3"><span style="font-size: 90px;  " class="<?php echo $list['icon']; ?>"></span></th>
                                <th scope="col"><b><?php echo $list['nama']; ?></b></th>
                                <th scope="col"><b><?php echo $list['status']; ?></b></th>
                                <th scope="col"><b><?php echo $list['jabatan']; ?></b></th>
                            </tr>
                        <?php } ?>
                    </table>
                    <!-- <div class="" style="color: black; font-family:poppins; margin-top:80px; margin-left:15px;">
                        <br>
