...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'IMSIS E-Kastemer';
...
$config['recaptcha_public_key'] = '6LeyaJseAAAAAPg0OLAbqUFQ1s8XCiLqXsGR6xv-';
$config['recaptcha_private_key'] = '6LeyaJseAAAAAI_ljKo0XgQtM4JFVzOwRo8rxpI3';
